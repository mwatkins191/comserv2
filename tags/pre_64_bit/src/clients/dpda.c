          ...
          switch (sel)
            {
              ...
              case 9 :
                {
                  ...
                  pshort = (pvoid) ((long) me + this->cominoffset) ;
                  *pshort = sel2 - 1 ;
              ...
              case 16 :
                {
                  ...
                  pshell = (pvoid) ((long) me + this->cominoffset) ;
              ...
              case 18 :
                {
                  ...
                  padj = (pvoid) ((long) me + this->cominoffset) ;
              ...
              case 19 :
                {
                  ...
                  if ((k < pe->min_mass_dur) || (k > pe->max_mass_dur))
                      ...
                      {
                        prc = (pvoid) ((long) me + this->cominoffset) ;
                        prc->board = sel ;
                        prc->duration = k ;
              ...
              case 20 :
                {
                  ...
                  low = lowest(pe->map) ;
                  high = highest(pe->map) ;
                  pcsc = (pvoid) ((long) me + this->cominoffset) ;
                  pcsc->calnum = sel ;
                  stopcal = FALSE ;
                  do
                    {
              ...
              case 21 :
                {
                  pdec = (pvoid) ((long) me + this->cominoffset) ;
                  pdec->count = 0 ;
              ...
              case 22 :
                {
                  ...
                  pdcc = (pvoid) ((long) me + this->cominoffset) ;
                  pdcc->id = sel2 ;
                  pdcc->dct_sp = 0 ;
                  printf ("Enable Detector [Y/N] : ") ;
                  gets (s1) ;
              ...
              case 23 :
                {
                  ...
                  prec = (pvoid) ((long) me + this->cominoffset) ;
                  prec->count = 0 ;
                  while (1)
                    {
                      if (prec->count == 8)
              ...
              case 25 :
                {
                  pdc = (pvoid) ((long) me + this->cominoffset) ;
              ...
              case 26 :
                {
                  puc = (pvoid) ((long) me + this->cominoffset) ;
                  printf ("File name on DA : ") ;
                  gets (s1) ;
                  if (s1[0] == '\0')
                      break ;
              ...
              case 27 :
                {
                  ...
                  if (err == CSCR_GOOD)
                      {
                        pls = (pvoid) &pcomm->moreinfo ;
                        plsc = (pvoid) ((long) me + this->cominoffset) ;
              ...
              case 28 :
                {
                  ...
                  pflood = (pvoid) ((long) me + this->cominoffset) ;
